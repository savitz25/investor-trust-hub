...
const sources=Object.fromEntries(['CO','VA','NY','IL','OR','PA'].map(c=>[c,m.acceptedStateSnapshots[c]]));
...
test('state IA / ERA / notice / office classes export independently, with exact overlap evidence',()=>{
 const expected={CO:[740,209,3673,589,6],VA:[697,107,3289,339,4],NY:[1297,327,5856,3152,27],IL:[855,55,3560,793,1],OR:[335,26,2262,167,3],PA:[864,99,3411,623,5]};
