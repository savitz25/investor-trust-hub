...
const ATTR_FIELDS = [
  ...
  'custody_cash',
  'custody_securities',
  'related_person_custody_cash',
  'related_person_custody_securities',
  'reports_private_funds',
  'private_fund_count_7b1',
  'private_fund_gross_assets',
  'clients_individuals',
  'clients_high_net_worth_individuals',
  'clients_banking_or_thrift',
  'clients_investment_companies',
  'clients_business_development_companies',
  'clients_pooled_investment_vehicles',
  'clients_pension_profit_sharing',
  'clients_charities',
  'clients_state_or_municipal',
  'clients_other_investment_advisers',
  'clients_insurance_companies',
  'clients_sovereigns',
  'clients_other',
  'other_business_broker_dealer',
  'other_business_registered_representative',
  'other_business_cpo_or_cta',
  'other_business_futures_commission_merchant',
  'other_business_real_estate',
  'other_business_insurance',
  'other_business_bank',
  'other_business_trust_company',
  'other_business_accountant',
  'other_business_lawyer',
  'other_business_other_financial_salesperson',
  'other_business_other',
  'affiliation_broker_dealer',
  'affiliation_other_investment_adviser',
  'affiliation_municipal_advisor',
  'affiliation_security_based_swap_dealer',
  'affiliation_major_security_based_swap_participant',
  'affiliation_cpo_or_cta',
  'affiliation_futures_commission_merchant',
  'affiliation_banking_or_thrift',
  'affiliation_trust_company',
  'affiliation_accountant',
  'affiliation_lawyer',
  'affiliation_insurance',
  'affiliation_pension_consultant',
  'affiliation_real_estate_broker',
  'affiliation_limited_partnership_sponsor',
  'affiliation_other',
];
