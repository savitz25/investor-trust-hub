...
export const NV_PUBLIC_SNAPSHOT = {
  ...
  "asOf": null,
  "generatedAt": "2026-09-25T19:01:50Z",
  "publicationGate": "ON",
  ...
  "clocks": {
    ...
    "nrs_retrievedAt": "2026-09-25T18:56:13Z",
    "division_site_checkedAt": "2026-09-25T18:55:00Z",
    "enforcement_latest_order_date": null,
  ...
  "nationalOverlay": {
    "nvPrincipalOfficeSecIardFirms": 99,
  ...
  "stateRia": {
    ...
    "registrationRows": 281,
    "distinctFirmCrd": 281,
    "approvedDistinctCrd": 271,
    "condrestDistinctCrd": 0,
    "termrequestDistinctCrd": 10,
    "currentDistinctCrd": 271,
    "statusRows": {
      "APPROVED": 271,
      "TERMREQUEST": 10
    },
    "principalOfficeNvAmongStateIa": 82,
  ...
  "federalNotice": {
    ...
    "noticeFiledWithNvPrincipalOffice": 74,
  ...
  "reconciliation": {
    "NV_STATE_IA_ERA_OVERLAP": 0,
    "NV_STATE_IA_WITH_NV_MAIN_ADDRESS": 82,
    "NV_PRINCIPAL_OFFICE_NOTICE_OVERLAP": 74,
    "NV_PRINCIPAL_OFFICE_NOT_NOTICE_FILED": 28,
    "NV_PRINCIPAL_OFFICE_OVERLAY": 99,
    "crossClock": {
      "NV_STATE_IA_NOTICE_OVERLAP": 3,
      "NV_ERA_NOTICE_OVERLAP": 0,
      "NV_PRINCIPAL_OFFICE_STATE_IA_OVERLAP_SEC_FEED": 1,
  ...
  "enforcement": {
    ...
    "uniqueMatters": null,
    "sourceTypesToPreserve": [
      "Consent Order",
      "Summary Order to Cease and Desist",
      "Administrative Order",
      "Other source-defined action"
    ],
    "divisionHome": "https://www.nvsos.gov/sos/licensing/securities",
    "accessResult": "REJECTED_BY_BOT_DEFENSE",
    "accessCheckedAt": "2026-09-25T18:55:00Z",
    "accessDetail": "Every page answered with an Imperva Incapsula 'Request unsuccessful' interstitial (about 1 KB, NOINDEX) to a plain HTTP client, and a normal Chrome session received the same interstitial. No bypass, alternate fetcher, cache or mirror was used.",
  ...
  "complaints": {
    "NV_SECURITIES_COMPLAINT_ROWS": null,
    "intake": "KNOWN",
  ...
  "divisionFramework": {
    ...
    "officialHomeUrl": "https://www.nvsos.gov/sos/licensing/securities",
    "statute": "Nevada Uniform Securities Act (NRS Chapter 90)",
    "statuteUrl": "https://www.leg.state.nv.us/nrs/NRS-090.html",
    "statuteRetrievedAt": "2026-09-25T18:56:13Z",
    "sections": [
      {
        "nrs": "90.215",
        "heading": "“Administrator” defined."
      },
      {
        "nrs": "90.230",
        "heading": "“Division” defined."
      },
      {
        "nrs": "90.310",
        "heading": "Licensing of broker-dealers, sales representatives and transfer agents."
      },
      {
        "nrs": "90.330",
        "heading": "Licensing of investment advisers and representatives of investment advisers."
      },
      {
        "nrs": "90.345",
        "heading": "Investment advisers to certain private funds exempt from licensing."
      },
      {
        "nrs": "90.620",
        "heading": "Investigations and subpoenas."
      },
      {
        "nrs": "90.630",
        "heading": "Enforcement."
  ...
  "expansionLedger": {
    "NET_NEW_STATE_RESEARCH_IDENTITIES": 271,
